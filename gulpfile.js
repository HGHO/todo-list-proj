...
gulp.task('js', function() {
  ...
  return gulp.src('bower_components/angular-modal-service/dst/angular-modal-service.js')
...
gulp.task('jshint', function() {
  return gulp.src(['*.js', 'samples/**/*.js', '!samples/vendor/**/*.js'])
    .pipe(jshint())
...
gulp.task('watch', function() {
  ...
  //  When the source file changes, build it. Whenever any JS changes hint it.
  gulp.watch(['src/*.js'], ['js']);
  gulp.watch(['*.js', 'src/*.js', 'samples/**/*.js', '!samples/vendor/**/*.js'], ['jshint']);
